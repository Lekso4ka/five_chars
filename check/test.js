const strangeWords = [
    ...
    "клира","комех","купка","карем","кучум","келия","ктырь","карль","крыль","калит","кварт","кутня","калеб","кельн","крыга","колли","кадил","кобол","катол","кошон",
    ...
    "нагой","назыв","напив","насев","нашив","несть","номов","носов","носух","неизм","несом","нехай","нагай","надум","нутка","нечег","несун","нафта","накол","надол",
    "отшив","обмяв","обнов","обдум","обнар","орчан","огарь","однех","остях","отрях","отмыв","отыск","осмат","облой","охань","охрим","оскол",
    ...
    "строг","стамб","секун",
    "триех","тезах","тугой","татах","татях","талях","талие","тычка","тезам","татем","трико","тенге","транш",
