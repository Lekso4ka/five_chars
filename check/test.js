const strangeWords = [
    ...
    "клира","комех","кошах","кличь","кореш","кащей","купка","карем","кучум","келия","ктырь","карль","керчь","крыль","калит","кварт","кутня","калеб","кельн","крыга","колли",
    "линях","лихой","лабух","лобыз","лейбл","лейба","лихор","луцка","лубка","лимба","лишар","лешка","лукум","ларго","ляссе","лазка","лучка","лутка","личик",
    "мгнов","манов","млина","мильх","миазм","мифим","мозем","манат","медяк","моцио","мокко","молье",
