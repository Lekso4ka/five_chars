const strangeWords = [
    ...
    "бурум","бадаб","бадей","багги","баден","балал","банит","баркл","барна","барск","барчо","баста","батал","батек","батик","батун","бахус","башта","бебут","безна","безоб","безос","безот","бекеш","белын","бемит","беник","бивня","болва","браво","бурша","бушка","бимса","брама","божка","божой","бачка","бочаг","богоз","барха","богос","брига","бойка","борой","боной","буряк","берус","билас","брест","барок","бинок","бокан","боток","бунда","бурат","бутен","бутит","билон","бленд","бобин","бобон","борон","бордо","биота","барын","брибр",
    "выдум","высов","выгов","впрок","вскок","вымыв","вчера","винов","виват","вычит","вебер","варьк","вдоль","впряг","вздув","вздум","вувер","вукол","вонам","вышин","вопия","вопки","вправ","вскип","высып","вывед","выдер","вызыв","выказ","вырин","выска","вытол","вздер","видло","водол","везир","верес","верна","верол","враля","ветел","витин","витик","вакан","веска","возик","воной","вклеп","вышиб","вперь","выраз","вырва",
    ...
    "дорыв","догов","дурье","дебай","дафан","дацит","диола","душко","дуоль","дроня","диско","долом",
    ...
    "клира","комех","кошах","кличь","кореш","купка","карем","кучум","келия","ктырь","карль","керчь","крыль","калит","кварт","кутня","калеб","кельн","крыга","колли",
    ...
    "прояв","почув","перов","погов","пораж","пораз","полов","палов","пацие","побыв","посов","позов","перех","покус","прямо","полун","полук","парль","паниб","переб",
    ...
    "филия","филея","фотом","фонем","фонар","феном","фуфло","фения","фотия","фрунт","фальш","фигня","фальс","фотка","фатом",
