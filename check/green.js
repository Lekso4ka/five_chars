const isWords = [
    ...
    "фетва","сцена","клико","пасма","пирке",
    "илька","мурка","релиз","штейн","альфа",
    "рафид","ольха","чечен","трасс","пинка",
    "кроше","вчера","фелон","тигра","манто",
    "мейоз","учхоз","ливан","квадр","патуа",
    "ризка","очкур","тимус","кодон","кашне",
    "граве","очник","мазар","порто","мамбо",
    "нивка","очерк","плаке","дедок","перун",
    "оскар",
    "ничто","учеба","маран","диана","кумол",
    "мурин","перло","экзот","трипс","писка",
