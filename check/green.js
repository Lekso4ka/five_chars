const isWords = [
    ...
    "смысл","бирюч","палея","горюн","канюк",
    "колюр","утица","чепан","хмарь","бареж",
    "гипюр","урема","дюбек","люпус","бирюк",
    "тюник","шорня","ангоб","девон","мезон",
    "велюр","унция","шутка","полть","приют",
    "рюшка","солея","типун","выжим","бювет",
    "дюшес","униат","вояка","тромп","лютич",
    ...
    "труха","одеон","шипун","лычко","босяк",
    "сваха","одурь","пончо","телик","обмин",
    "плаха","рдест","кифоз","вынос","сдвиг",
    "кроха","идиом","фураж","бочар","выпас",
    "волхв","цуцик","колье","шляпа","саджа","блоха",
    "идиот","шайка","чернь","приуз","гуцул",
    "вдова","ранчо","сейша","цибик","лизун",
    "чукча","дрязг","плешь","цехин","обжим",
    "причт","глясе","мокша","будра","раджа",
    "круча","дрянь","форте","взрез","порча",
    "","","","","","","","","","","","","","","",
]